...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-xs sm:max-w-lg md:max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-6 border border-border bg-background p-4 sm:p-8 md:p-10 shadow-2xl rounded-2xl",
        className
      )}
      {...props}
    >
